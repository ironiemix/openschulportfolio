...
$excl = array( 'TABLES', 'LISTS', 'IMAGES-CORE', 'IMAGES-PNG-GIF',
'IMAGES-WMF', 'IMAGES-OTHER', 'TABLES-ADVANCED-BORDERS', 'UNICODE-FONTS', 'HTMLHEADERS-FOOTERS', 'COLUMNS', 'TOC', 'INDEX', 'BOOKMARKS', 'BARCODES', 'FORMS', 'WATERMARK', 'RTL', 'INDIC', 'CJK', 'ANNOTATIONS', 'GRADIENTS', 'BACKGROUND-IMAGES', 'CSS-FLOAT', 'CSS-IMAGE-FLOAT', 'CSS-POSITION', 'CSS-PAGE', 'BORDER-RADIUS', 'HYPHENATION', 'ENCRYPTION', 'DIRECTW');


	// *DIRECTW* = Write, WriteText, WriteCell, Text, Shaded_box, AutosizeText
	// IMAGES-CORE = [IMAGES-WMF, IMAGES-PNG-GIF, IMAGES-OTHER] (not JPG) NB background-images and watermark images
...
<div><b>Notes</b>
<ul>
<li>For Images, you must include both IMAGES-CORE and the image file-types you need e.g. IMAGES-PNG-GIF</li>
<li>JPG images are supported with just IMAGES-CORE</li>
<li>IMAGES-CORE and the image filetypes are required for BACKGROUND-IMAGES or WATERMARKS to work</li>
