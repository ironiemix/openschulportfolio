...
$this->debug = false;
$this->showImageErrors = false;		// false/true; can set = 2 to show errors on primary parsing of PNG files
...
// IMAGES
$this->gif2jpg = false;	// Changes GIF images to JPG - much faster; little loss of quality; loses transparency; requires GD >= 2.0.28
...
$this->defaultCSS = array(
	'BODY' => array(
		...
		'FONT-SIZE' => '11pt',
		'TEXT-ALIGN' => 'left',
		'TEXT-INDENT' => '0pt',	/* Moved from P mPDF 4.0 */
		'LINE-HEIGHT' => 1.33,
