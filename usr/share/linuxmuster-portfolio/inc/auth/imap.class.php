...
class auth_imap extends auth_basic {
     ...
     *
     * Checks if the given user exists in dokuWiki, and 
     * user and password exists on an IMAP/pop3 server, 
     *
     * @author  Andreas Gohr <andi@splitbrain.org>
     * @author  Kenneth Yrke Joergensen <mail@yrke.dk>
     * @return  bool
    ...
    function checkPass($user,$pass){
      ...
      $toReturn=false; 
    	...
    	$imap_login = @imap_open("{localhost:143/novalidate-cert}", $user , $pass);
